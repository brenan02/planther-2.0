...
class _VerifyEmailScreenState extends State<VerifyEmailScreen> {
  ...
  void _showMessage(String msg, {bool isError = true}) {
    ScaffoldMessenger.of(context).showSnackBar(SnackBar(
      content: Text(msg),
      backgroundColor:
          isError ? Colors.redAccent : const Color(0xFF4b986c986c),
            ...
            children: [
              ...
              Center(
                child: Container(
                  ...
                  height: 80,
                  decoration: BoxDecoration(
                    color: const Color(0xFF4b986c986c).withOpacity(0.1),
                    shape: BoxShape.circle,
                  ),
                  child: const Center(
                    child: Icon(Icons.mark_email_unread_outlined,
                        color: Color(0xFF4b986c986c), size: 38),
                  ),
                ),
              ),
                ...
                child: GestureDetector(
                  ...
                  child: const Text(
                    ...
                    style: TextStyle(
                      ...
                      decorationColor: Color(0xFF4b986c986c),
                    ),
                  ),
                ),
              ),
